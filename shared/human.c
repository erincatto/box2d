				  ...
				  float dampingRatio, int groupIndex, void* userData, bool colorize )
{
	...
	// hip
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.95f * s } );
	...
	// torso
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.2f * s } );
		bodyDef.linearDamping = 0.0f;
		bodyDef.name = "torso";
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.0f * s } );
	...
	// head
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f * s, 1.475f * s } );
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.4f * s } );
		b2RevoluteJointDef jointDef = b2DefaultRevoluteJointDef();
		jointDef.base.bodyIdA = human->bones[bone->parentIndex].bodyId;
		jointDef.base.bodyIdB = bone->bodyId;
		jointDef.base.localFrameA.p = b2Body_GetLocalPoint( jointDef.base.bodyIdA, pivot );
	...
	// upper left leg
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.775f * s } );
		bodyDef.linearDamping = 0.0f;
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.9f * s } );
		b2RevoluteJointDef jointDef = b2DefaultRevoluteJointDef();
		jointDef.base.bodyIdA = human->bones[bone->parentIndex].bodyId;
		jointDef.base.bodyIdB = bone->bodyId;
		jointDef.base.localFrameA.p = b2Body_GetLocalPoint( jointDef.base.bodyIdA, pivot );
	...
	// lower left leg
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.475f * s } );
		bodyDef.linearDamping = 0.0f;
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.625f * s } );
		b2RevoluteJointDef jointDef = b2DefaultRevoluteJointDef();
		jointDef.base.bodyIdA = human->bones[bone->parentIndex].bodyId;
		jointDef.base.bodyIdB = bone->bodyId;
		jointDef.base.localFrameA.p = b2Body_GetLocalPoint( jointDef.base.bodyIdA, pivot );
	...
	// upper left arm
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.225f * s } );
		bodyDef.linearDamping = 0.0f;
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.35f * s } );
		b2RevoluteJointDef jointDef = b2DefaultRevoluteJointDef();
		jointDef.base.bodyIdA = human->bones[bone->parentIndex].bodyId;
		jointDef.base.bodyIdB = bone->bodyId;
		jointDef.base.localFrameA.p = b2Body_GetLocalPoint( jointDef.base.bodyIdA, pivot );
	...
	// lower left arm
	{
		...
		bodyDef.position = b2OffsetPosition( position, (b2Vec2){ 0.0f, 0.975f * s } );
		bodyDef.linearDamping = 0.1f;
		...
		b2Position pivot = b2OffsetPosition( position, (b2Vec2){ 0.0f, 1.1f * s } );
		b2RevoluteJointDef jointDef = b2DefaultRevoluteJointDef();
		jointDef.base.bodyIdA = human->bones[bone->parentIndex].bodyId;
		jointDef.base.bodyIdB = bone->bodyId;
		jointDef.base.localFrameA.p = b2Body_GetLocalPoint( jointDef.base.bodyIdA, pivot );
