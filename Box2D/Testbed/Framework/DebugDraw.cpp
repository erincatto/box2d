...
struct GLRenderPoints
{
    ...
    void Flush()
	{
		...
		glVertexAttribPointer(m_vertexAttribute, 2, GL_FLOAT, GL_FALSE, sizeof(struct Vertex), BUFFER_OFFSET(offset));
		offset += sizeof(b2Vec2);
		glEnableVertexAttribArray(m_colorAttribute);
		glVertexAttribPointer(m_colorAttribute, 4, GL_FLOAT, GL_FALSE, sizeof(struct Vertex), BUFFER_OFFSET(offset));
		offset += sizeof(b2Color);
		glEnableVertexAttribArray(m_sizeAttribute);
		glVertexAttribPointer(m_sizeAttribute, 1, GL_FLOAT, GL_FALSE, sizeof(struct Vertex), BUFFER_OFFSET(offset));
		offset += sizeof(float);
...
struct GLRenderTriangles
{
    ...
    void Flush()
	{
		...
		glEnableVertexAttribArray(m_vertexAttribute);
		glVertexAttribPointer(m_vertexAttribute, 2, GL_FLOAT, GL_FALSE, sizeof(struct Vertex), BUFFER_OFFSET(0));
		glEnableVertexAttribArray(m_colorAttribute);
		glVertexAttribPointer(m_colorAttribute, 4, GL_FLOAT, GL_FALSE, sizeof(struct Vertex), BUFFER_OFFSET(0));
