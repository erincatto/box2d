...
B2_REC_OP( 0x08, WorldSetContactTuning,        RET_NONE, ARG( WORLDID, world ) ARG( F32, hertz ) ARG( F32, dampingRatio ) ARG( F32, pushSpeed ) )
...
B2_REC_OP( 0x2A, BodyApplyLinearImpulse,      RET_NONE, ARG( BODYID, body ) ARG( VEC2, impulse ) ARG( VEC2, point ) ARG( BOOL, wake ) )
...
B2_REC_OP( 0x5F, ShapeApplyWind,            RET_NONE, ARG( SHAPEID, shape ) ARG( VEC2, wind ) ARG( F32, drag ) ARG( F32, lift ) ARG( BOOL, wake ) )
